...
# left ground
left_ground = game.BrickGround(-tile_size[0]*9, tile_size[1]*7, 9, 7, game_graphics, top_wall=False, left_wall=False, bottom_wall=False)
# left_ground.set_all_image_sizes()
grounds.append(left_ground)

left_ground_filler = game.BrickGround(left_ground.x, left_ground.y-left_ground.height, left_ground.brick_width, 7, game_graphics, top_wall=False, left_wall=False, bottom_wall=False, right_wall=False)
...
base_ground1_filler = game.BrickGround(0, -2*tile_size[1], 3, 5, game_graphics, top_wall=False, left_wall=False, bottom_wall=False, right_wall=False)
...
base_ground2_filler = game.BrickGround(base_ground2.x, base_ground2.y-base_ground2.height, 15, 3, game_graphics, top_wall=False, left_wall=False, bottom_wall=False, right_wall=False)
...
base_ground3_filler = game.BrickGround(base_ground3.x, base_ground3.y-base_ground3.height, 7, 2, game_graphics, top_wall=False, left_wall=False, bottom_wall=False, right_wall=False)
...
base_ground5_filler = game.BrickGround(base_ground5.x, base_ground5.y-base_ground5.height, 10, 1, game_graphics, top_wall=False, left_wall=False, bottom_wall=False, right_wall=False)
...
base_ground6_filler = game.BrickGround(base_ground6.x, base_ground6.y-base_ground6.height, 30, 1, game_graphics, top_wall=False, left_wall=False, bottom_wall=False, right_wall=False)
...
base_ground7_filler = game.BrickGround(base_ground7.x, base_ground7.y-base_ground7.height, 15, 1, game_graphics, top_wall=False, left_wall=False, bottom_wall=False, right_wall=False)
grounds.append(base_ground7_filler)

# base ground 7
base_y_follow += 5
base_ground8 = game.BrickGround(base_x_follow*tile_size[0], base_y_follow*tile_size[1], 9, 5, game_graphics, bottom_wall=False, right_wall=False, top_wall=False)
grounds.append(base_ground8)
base_x_follow += base_ground8.brick_width

base_ground8_filler = game.BrickGround(base_ground8.x, base_ground8.y-base_ground8.height, 9, 5, game_graphics, top_wall=False, left_wall=False, bottom_wall=False, right_wall=False)
